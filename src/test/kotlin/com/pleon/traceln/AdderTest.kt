...
import com.pleon.traceln.component.Adder
...
class AdderTest {
    ...
    @Test fun checkMapSizeForOneEntry() {
        adder.add("Java", 10)

        assertThat(adder.getResult().size).isEqualTo(1)
    }

    @Test fun getResultForOneJavaFile() {
        adder.add("Java", 10)

        assertThat(adder.getResult()[0].lines).isEqualTo(10)
    }

    @Test fun getResultForTwoJavaFile() {
        adder.add("Java", 10)
        adder.add("Java", 6)
    ...
    @Test fun checkMapSizeForTwoDifferentEntry() {
        adder.add("Java", 10)
        adder.add("Kotlin", 9)
    ...
    @Test fun getResultForMultipleAdditions() {
        adder.add("Java", 10)
        adder.add("Other", 15)
        adder.add("Kotlin", 8)
    ...
    @Test fun getPercentForOneJava() {
        adder.add("Java", 4)

        assertThat(adder.getResult()[0].percentage).isEqualTo(100.0)
    }

    @Test fun getPercentForEqualJavaAndKotlin() {
        adder.add("Java", 13)
        adder.add("Kotlin", 13)
